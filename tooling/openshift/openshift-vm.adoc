...
----
minishift start --memory=4000 --vm-driver=virtualbox --iso-url=https://github.com/minishift/minishift-centos-iso/releases/download/v1.0.0-rc.4/minishift-centos7.iso --docker-env=[storage-driver=devicemapper]
----

Version of MiniShift to be used is **= 1.0.0.Beta5**

You can download the iso file on your machine and reuse it

----
mkdir -p $HOME/iso
curl -L -o $HOME/iso/minishift-centos7.iso https://github.com/minishift/minishift-centos-iso/releases/download/v1.0.0-rc.4/minishift-centos7.iso 
