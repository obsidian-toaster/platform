...
The new CDK - version3 which is based on latest code of Minishift is available https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/view/CDK/job/cdk_build/ws/[here] for daily build
