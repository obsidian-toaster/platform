  ...
  *"swarm"*)
  ...
  case $name in
    ...
    *"swarm"*)
        ...
        oc env dc/secured-swarm-rest SSO_SECRET=cb7a8528-ad53-4b2e-afb8-72e9795c27c8
        ;;
  esac
  ...
  #
  echo "==============================="
  echo " Call the Secured Service : $APP/greeting" using token issued by the SSO Server
  echo "==============================="
  cd $CURRENT
